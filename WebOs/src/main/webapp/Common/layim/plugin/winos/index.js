...
layui.config({
    base: 'Common/layim/plugin/winos/' //指定 winui 路径
    , version: '1.0.0-beta'
}).extend({  //指定js别名
    ...
    helper: 'js/winui.helper',
        ...
        winui.config({
            ...
            desktop: {
                options: {},    //可以为{}  默认 请求 json/desktopmenu.json
                    ...
                    desktopApp.contextmenu({
                        item: ["删除&&fa fa-trash fa-fw", '刷新&&fa fa-fw fa-refresh'],
                        item0: function (id, elem) {
            ...
            menu: {
                options: {
                    url: '/api/Users/GetAppList',// winui.path + 'json/desktopmenu.json',
                    method: 'post',
                    headers: { "Authorization": "bearer " + window.sessionStorage["_token"] } // url: 'Common/json/allmenu.json',
