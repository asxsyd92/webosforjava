...
layui.define(['laypage', 'form'], function (exports) {
        ...
        var a = {
            ...
            createList: function (text) {
                ...
                for (var i = 0; i < _pages; i++) {
                    // 按limit分块
                    var lm = $('<div class="layui-iconpicker-icon-limit" style="text-align: center;" id="layui-iconpicker-icon-limit-' + tmp + (i + 1) + '">');
    ...
    IconPicker.prototype.checkIcon = function (filter, iconName) {
        var el = $("#" + filter) ,//$('*[lay-filter=' + filter + ']'),
