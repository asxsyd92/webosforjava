...
layui.define(['jquery','layer','form'], function(exports) {
    var $ = layui.$,
        layer = layui.layer,
        form = layui.form;
    layui.addcss("../../../dtree/dtree.css");
    layui.addcss("../../../dtree/font/dtreefont.css");
    // 树的公共定义样式汇总
        ...
        AjaxHelper.request({
            ...
            success: function(result) {
                ...
                if (_this.dataStyle == 'layuiStyle'){
                    ...
                    code = 200; //result.status[_this.response.statusName];
                }
                ...
                if (code == _this.response.statusCode) {
                    ...
                    if (_this.dataStyle == 'layuiStyle'){
                        ...
                        _this.obj.html(_this.getNoneDom().errText(result.msg));
                        _this.error(null, code, result.msg);
                    }
                }
            },
