...
layui.define(['jquery', 'layer', 'form', 'common', 'element', 'laytpl', 'tree', 'util'], function (exports) {
    ...
    var utils = {
        ...
        YLrun: function () {
            ...
            $.post("/api/Form/FormDesignYL", { html: formhtml }, function (data) {
                console.log(data);
        ...
        table: function (key) {
            ...
            if (key !== null) {
                var iskeyid = key;
                var tabkey = common.getRequest().tabkey;
                if (tabkey !== null && tabkey !== undefined) {
                    iskeyid = iskeyid + "&id="+tabkey;
                }
                $.get('/api/Form/FormTable?table=' + iskeyid, {}, function (res) {
                    //
    ...
    $("#_rormname").blur(function () {
        ...
        common.get("/api/Form/GetCheckName", { Name: Name}, function (resp) {
            var ks = resp;
            if (ks.Success) {
                layer.msg(ks.msg);
                $('#_rormname').val(Name);
